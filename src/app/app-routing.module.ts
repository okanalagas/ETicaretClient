...
const routes: Routes = [
  {
    path: "admin", component: LayoutComponent, children: [
      { path: "", component: DashboardComponent },    //ww..../.../admin dendiğinde açılacak sayfa yönlendirmesi
      { path: "customers", loadChildren: () => import("./admin/components/customers/customers.module").then(module => module.CustomersModule) },  //customers cagrısına karşılık açılacak sayfa
